...
function crearClaseMascota() {
  class Mascota {
    ...
    getActividades() {
      ...
      // Tu código aca:
      const actividades = this.actividades.map(({ actividad }) => actividad);
      return actividades;
    }
    ...
    getFrecuencia(actividad) {
      ...
      // Tu código aca:
      const respuesta = this.actividades.filter(actividadActual => actividadActual.actividad === actividad);
      return respuesta[0].frecuencia;
    }
  }
